...
import {changeFollow} from "../../redux/header-reducer";
        ...
        const arr = this.props.headerdata.map((el) => {
            return <div>
                ...
                <div onClick={() => {
                    ...
                    <p onMouseDown={e=>{e.preventDefault()}}>{el.rusName}</p>
                    ...
                    {el.isFollow ?<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                        ...
                        : <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                            <path id="_Color" data-name=" ↳Color" d="M16,18H2a2,2,0,0,1-2-2V2A2,2,0,0,1,2,0H16a2,2,0,0,1,2,2V16A2,2,0,0,1,16,18ZM2,2V16H16V2Z"/>
                        </svg>
...
export default connect(mapStateToProps, {changeFollow})(HeaderContainer);