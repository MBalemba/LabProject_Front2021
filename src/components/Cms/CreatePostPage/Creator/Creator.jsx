        ...
        return (<>
                <div className={this.state.modaldown ? (s.createwind+' '+s.down): s.createwind }>
                    ...
                    <div className={s.right}>
                        <button>
                            <svg id="plus" xmlns="http://www.w3.org/2000/svg" width="127.5" height="127.5" viewBox="0 0 127.5 127.5">
                                <path id="Контур_232" data-name="Контур 232" d="M188.151,248.02H132.01a4.01,4.01,0,1,1,0-8.02h56.141a4.01,4.01,0,0,1,0,8.02Zm0,0" transform="translate(-96.33 -180.26)" fill="#28b6d9"/>
                                <path id="Контур_233" data-name="Контур 233" d="M244.01,192.161a4.012,4.012,0,0,1-4.01-4.01V132.01a4.01,4.01,0,1,1,8.02,0v56.141A4.011,4.011,0,0,1,244.01,192.161Zm0,0" transform="translate(-180.26 -96.33)" fill="#28b6d9"/>
                                <path id="Контур_234" data-name="Контур 234" d="M112.89,127.5H14.61A14.622,14.622,0,0,1,0,112.89V14.61A14.622,14.622,0,0,1,14.61,0H112.89A14.622,14.622,0,0,1,127.5,14.61V112.89A14.622,14.622,0,0,1,112.89,127.5ZM14.61,7.969A6.65,6.65,0,0,0,7.969,14.61V112.89a6.65,6.65,0,0,0,6.641,6.641H112.89a6.65,6.65,0,0,0,6.641-6.641V14.61a6.65,6.65,0,0,0-6.641-6.641Zm0,0" fill="#28b6d9"/>
                            </svg>
                        ...
                        <div onClick={this.modalMove.bind(this)} className={this.state.modaldown ?s.grip+' '+s.down: s.grip}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="35.86" height="36.659" viewBox="0 0 35.86 36.659">
                                <g id="_3f4f8e5619fbbf55669bece66b224fc5" data-name="3f4f8e5619fbbf55669bece66b224fc5" transform="translate(-30.592 -30.209)">
                                    <g id="Сгруппировать_53" data-name="Сгруппировать 53" transform="translate(10 10)">
                                        <path id="Контур_240" data-name="Контур 240" d="M282.32,291.871a1.527,1.527,0,0,0,1.525,1.525h22.42a1.525,1.525,0,0,0,1.242-2.406l-16.391-23.309a1.582,1.582,0,0,0-2.492,0L272.218,291a1.52,1.52,0,0,0,1.242,2.4,1.539,1.539,0,0,0,1.25-.645l15.156-21.54,13.466,19.134H283.845A1.527,1.527,0,0,0,282.32,291.871Z" transform="translate(-251.347 -246.866)"/>
                                        <path id="Контур_241" data-name="Контур 241" d="M273.525,697.65h32.8a1.525,1.525,0,0,0,0-3.05h-32.8a1.525,1.525,0,0,0,0,3.05Z" transform="translate(-251.404 -640.782)"/>
                                    </g>
                                </g>
                            </svg>
                        </div>
